...
## Accepted Calls
If you accept a call, you will see it show up in your accepted calls container. If you have accpetede a call and no longer can make the scheduled call, please reach out to us ASAP. 
